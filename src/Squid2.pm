...
# Settings: Define all variables needed for configuration of squid
...
sub Read {
    ...
    my $caption = __("Initializing squid Configuration");
...
sub Write {
    ...
    # Squid read dialog caption
    my $caption = __("Saving squid Configuration");
